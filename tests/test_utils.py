...
@pytest.mark.parametrize(
    ...
    [pytest.param(0, (add_one, add_one), 2), pytest.param(0, (add_one, divisible_by_3), False)],
)
...
@pytest.mark.parametrize(
    ...
    [pytest.param("", has_len, True), pytest.param("abc", has_len, False)],
)
...
@pytest.mark.parametrize(
    ("input_args", "fn", "expected_result"),
    [pytest.param("abc", has_len, True), pytest.param("", has_len, False)],
)
